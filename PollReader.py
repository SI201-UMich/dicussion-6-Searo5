...
class PollReader():
    ...
    def build_data_dict(self):
        ...
        for row in self.raw_data[1:]:  # Skip the header row
    ...
    def likely_voter_polling_average(self):
        ...
        if likely_voter_count > 0:
            return (harris_total / likely_voter_count, trump_total / likely_voter_count)
        else:
            return (0.0, 0.0)
        pass
    ...
    def polling_history_change(self):
        ...
        harris_change = early_harris - late_harris
        trump_change = early_trump - late_trump
